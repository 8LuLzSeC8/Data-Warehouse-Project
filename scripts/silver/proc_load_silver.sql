...
Note:
    This procedure truncates the data in the silver tables before loading. If 
    you need to append new data modify or create a new procedure without
    truncating the tables before loading.
