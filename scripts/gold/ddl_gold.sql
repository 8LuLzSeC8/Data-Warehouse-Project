...
SELECT
    ...
    CASE 
        WHEN ci.cst_gndr != 'N/A' THEN ci.cst_gndr -- CRM is considered the primary source
...
SELECT
    ROW_NUMBER() OVER (ORDER BY pin.prd_start_dt,pin.prd_key) AS product_key, -- Surrogate key
